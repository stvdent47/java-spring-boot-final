...
import mephi.bookingservice.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleBookingException(
        ...
        log.warn(
            "Booking error: ref={}, code={}, message={}",
            ex.getBookingReference(),
            ex.getErrorCode(),
            ex.getMessage()
        );
    ...
    public ResponseEntity<ErrorResponse> handleHotelServiceException(
        ...
        log.error("Hotel Service error: statusCode={}, message={}", ex.getStatusCode(), ex.getMessage());
